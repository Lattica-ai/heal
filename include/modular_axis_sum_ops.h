 ...
 *
 * ## Behavior:
 * - Sums over axis 1 of `a` and axis 0 of `b`.
 * - If `apply_perm` is true, the axis -1 is permuted according to `perm`.
 ...
 *
 * ## Throws:
 * - std::invalid_argument if input shapes are invalid, or if moduli are not positive.
 *
 * ## Example usage:
 * ```
